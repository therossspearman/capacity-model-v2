...
export const ScenarioSelector = ({ scenarios, activeScenario, onSelect, onCreate, onClone, onDelete, onRevert, onRename, onManage, onCompare, ...props }) => {
    ...
    const DraftIcon = <svg style={{ width: '20px', height: '20px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>;
    const CheckIcon = <svg style={{ width: '16px', height: '16px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>;
        ...
        <div style={{ position: 'relative' }} ref={dropdownRef} {...props}>
            <button
                ...
                style={{
                    ...
                    borderRadius: '10px',
                    backgroundColor: isLiveMode ? 'rgba(248, 250, 252, 0.8)' : 'linear-gradient(to right, #F7F3ED, #eef2ff)',
